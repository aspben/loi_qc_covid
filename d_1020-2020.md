...
Côte-Nord
Gaspésie-Îles-de-la-Madeleine, uniquement pour la
...
de l' Estrie;
de l'Outaouais;
de la Gaspésie—Îles-de-la-Madeleine, sauf pour la
Communauté maritime des Îles-de-la-Madeleine;
de Laval;
des Laurentides;
    ...
    à moins:
        ...
        b.1) qu’elle soit pratiquée à l’extérieur dans un lieu où les activités ne sont pas autrement suspendues dans un contexte qui n’est pas une ligue, un tournoi ou une compétition, par un groupe d’au plus 8 personnes auquel peut s’ajouter une personne pour guider ou encadrer une
        telle activité et qu’une distance minimale de deux mètres entre les personnes soit maintenue en tout temps sauf s’il s’agit des occupants d’une même résidence privée ou de ce qui en tient lieu;

        b.2) qu’elle soit pratiquée à l’intérieur, dans le cadre d’un cours auquel seuls des occupants d’une même résidence privée ou de ce qui en tient lieu y participent ou y assistent, dans un lieu où les activités ne sont pas autrement suspendues et qu’une distance minimale de deux
        mètres entre le formateur et les autres personnes soit maintenue en tout
        temps;
